...
COMMUNITY_POSTS_DATA = {
    "posts": [
        {
            "id": "c1",
            "title": "[SERVER] 当非遗音乐碰上现代电子乐",
            "subtitle": "[SERVER] 融合节奏与古调，社区热议中",
            "body": "我在排练厅尝试把古琴散板与电子底鼓叠在一起，意外得到了很有空间感的声场。后续会分享工程文件与分轨思路，欢迎同好一起实验。",
            "category": "FolkInstrument",
        },
        {
            "id": "c2",
            "title": "[SERVER] 挖掘小众非遗音乐",
            "subtitle": "[SERVER] 发现被忽略的民间曲调与传承人",
            "body": "走访西南山区时录到几段口传小调，准备整理成短纪录片配乐。若你有类似采风素材，欢迎留言交流版权与署名方式。",
            "category": "Electronic",
        },
        {
            "id": "c3",
            "title": "[SERVER] 自制非遗音乐动画，邀你共赏",
            "subtitle": "[SERVER] 用动画讲述非遗旋律的故事",
            "body": "用二维骨骼动画复现了一段皮影戏节奏，配乐用的是改编后的工尺谱旋律。渲染还在优化，先抛砖引玉。",
            "category": "Ai",
        },
        {
            "id": "c4",
            "title": "[SERVER] 探访民间艺人，记录非遗音乐传承",
            "subtitle": "[SERVER] 走访记录，留存声音与记忆",

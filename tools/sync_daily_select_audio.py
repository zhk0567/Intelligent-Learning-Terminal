# -*- coding: utf-8 -*-
"""将 `data/音频/每日精选` 下 mp3 拷到小程序 / Web / Android raw，文件名 `daily_select_01.mp3` …（按排序）。"""
...
SRC = ROOT / "data" / "音频" / "每日精选"
OUT_MP = ROOT / "miniprogram" / "audio" / "daily_select"
OUT_WEB = ROOT / "web" / "public" / "audio" / "daily_select"
...
def main():
    ...
    for i, src in enumerate(files, start=1):
        name = f"daily_select_{i:02d}.mp3"

# -*- coding: utf-8 -*-
"""从 `data/图片/每日热门` 生成每日热门曲目封面：`daily_hot_cover_01.jpg` …（与音频 `daily_hot_01.mp3` 顺序一致）。"""
...
SRC = ROOT / "data" / "图片" / "每日热门"
OUT_MP = ROOT / "miniprogram" / "images" / "daily_hot"
OUT_WEB = ROOT / "web" / "public" / "images" / "daily_hot"
...
def main():
    ...
    for i, src in enumerate(files, start=1):
        name = f"daily_hot_cover_{i:02d}.jpg"

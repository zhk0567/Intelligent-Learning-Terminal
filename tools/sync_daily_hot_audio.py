# -*- coding: utf-8 -*-
"""将 `data/音频/每日热门` 下 mp3 拷到小程序 / Web / Android raw，文件名 `daily_hot_01.mp3` …（按排序）。"""
...
SRC = ROOT / "data" / "音频" / "每日热门"
OUT_MP = ROOT / "miniprogram" / "audio" / "daily_hot"
OUT_WEB = ROOT / "web" / "public" / "audio" / "daily_hot"

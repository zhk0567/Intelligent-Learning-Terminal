# -*- coding: utf-8 -*-
"""从 `data/图片/基础学习` 生成封面：`basic_lesson_cover_01.jpg` …（与 `basic_lesson_01.mp4` 顺序一致）。"""
...
SRC = ROOT / "data" / "图片" / "基础学习"
OUT_MP = ROOT / "miniprogram" / "images" / "basic_lesson"
OUT_WEB = ROOT / "web" / "public" / "images" / "basic_lesson"
...
def main():
    ...
    for i, src in enumerate(files, start=1):
        name = f"basic_lesson_cover_{i:02d}.jpg"

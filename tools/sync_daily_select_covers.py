# -*- coding: utf-8 -*-
"""从 `data/图片/每日精选` 生成封面：`daily_select_cover_01.jpg` …（与 `daily_select_01.mp3` 顺序一致）。"""
...
SRC = ROOT / "data" / "图片" / "每日精选"
OUT_MP = ROOT / "miniprogram" / "images" / "daily_select"
OUT_WEB = ROOT / "web" / "public" / "images" / "daily_select"
...
def main():
    ...
    for i, src in enumerate(files, start=1):
        name = f"daily_select_cover_{i:02d}.jpg"
